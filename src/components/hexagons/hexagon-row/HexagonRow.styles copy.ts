...
// // type TGetCalc<T> = T extends (
// // 	vals: ReturnType<TScalingFunction | TDualScalingFunction>,
// // 	dual: infer U
// // ) => U extends boolean ? [string, string] : string;

// interface props {
// 	vals: ReturnType<TScalingFunction | TDualScalingFunction>;
// 	dual: boolean | undefined;
// }
// type b<U> = U extends boolean ? [string, string] : string;
// const getCalc = ({ vals, dual }: props) => {
...
// 			: `calc(${innerStr})`
// 	) as b<typeof dual>; // ) as ReturnType<GetFirstArgumentOfAnyFunction>;
// };
// const withCalc =
// 	(
// 		fn: TDualScalingFunction | TScalingFunction,
// 		dual: boolean | undefined = undefined
// 	) =>
// 	(...args: Parameters<typeof fn>) =>
// 		getCalc({ vals: fn(...(args as [any])), dual });
...
// // type b = ReturnType<typeof calculateColGap>
