...
const experienceData = [
  {
    ...
    description: "Joe has run workshops on how to get more out of Generative AI tools with some of the biggest companies in the world through the Growth House 'AI for a Fast Start Program'.",
  },
  {
    title: 'AI Ethicist',
    description: 'Joe has studied the Ethics of AI at the University of Cambridge since 2020, culminating in being part of the university’s first ever MPhil in the Ethics of AI, Data and Algorithms.',
  },
];
  ...
  return (
    <section className={styles.reviewsSection}>
      ...
      <p className={styles.reviewsIntro}>
        For client reviews of Joe's prior AI training work, see the The Growth House's AI Programme page:
      </p>
      <a
      ...
      >
        ...
        <div className={styles.cardGraphicContainer}>
          <div className={`${styles.graphicBlock} ${styles.block1}`}>THE</div>
          <div className={`${styles.graphicBlock} ${styles.block2}`}>GROWTH</div>
          <div className={`${styles.graphicBlock} ${styles.block3}`}>HOUSE</div>
        </div>
        <div className={styles.cardTextContent}>
          <div className={styles.cardSiteInfo}>
            <img src={growthHouseFavicon} alt="The Growth House Favicon" />
            <span>The Growth House</span>
          </div>
          <h3 className={styles.cardTitle}>AI Programme - The Growth House</h3>
          <p className={styles.cardDescription}>
            You shouldn't worry about being replaced by AI, you should worry about being replaced by someone who knows how to use AI better than you
          </p>
        </div>
